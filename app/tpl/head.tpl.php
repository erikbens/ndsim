...
use Plinth\Common\Language;
	...
	$keywords = array('ogame','gameforge','universeview','warsaalk','ndsim', 'ogotcha','trashsim','combat simulator','simulator','websim','origin','websim','speedsim','ogame origin','osimulate','galaxy','battle simulator','combat simulator ogame','simulator','ogame simulator','ogame battle simulator','ogame combat simulator');
